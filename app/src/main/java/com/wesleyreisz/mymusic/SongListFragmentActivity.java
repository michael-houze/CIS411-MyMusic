...
public class SongListFragmentActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_song_list_fragment);

        ListView listView = (ListView) findViewById(R.id.songListView);
        List<Song> songs = new MockMusicService().findAll();
        SongAdapter songAdapter = new SongAdapter(this, R.layout.activity_song_list_fragment, songs);
